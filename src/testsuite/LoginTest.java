...
//Find username  locator by id provide value by sendskeys
        ...
        userPassWord.sendKeys("moli1288");
        //
        try {
            ...
            // WebElement display = driver.findElement(By.xpath("/html/body/div[6]/div[1]/div[1]/div[2]/div[1]/ul/li[2]/a"));
            //String expectedMessage = "Log out";
            // Assert.assertEquals("text not display", expectedMessage, display.getText());
            // Assert.assertEquals("Log out", driver.findElement(By.xpath("//a[@class='ico-logout']")));
...
//Find username  locator by id provide value by sendskeys
            ...
            // Find password locator by name, provide value by sendkeys
            WebElement userPassWord = driver.findElement(By.name("Password"));
            userPassWord.sendKeys("moli1289");
            //
            WebElement userLogIn = driver.findElement(By.xpath("//button[@class='button-1 login-button']"));
            userLogIn.click();
